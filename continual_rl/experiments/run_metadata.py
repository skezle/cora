...
class RunMetadataSkills(object):
    def __init__(self, output_dir):
        self._metadata = None
        self._output_dir = output_dir
        self.load()
    ...
    @property
    def skill_id(self):
        return self._metadata.get("skill_id", 0)

    @property
    def skill_timesteps(self):
        return self._metadata.get("skill_timesteps", 0)
    ...
    def save(self, cycle_id, skill_id, skill_timesteps, total_train_timesteps):
        self._metadata["cycle_id"] = cycle_id
        self._metadata["skill_id"] = skill_id
        self._metadata["skill_timesteps"] = skill_timesteps
        self._metadata["total_train_timesteps"] = total_train_timesteps
