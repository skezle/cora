...
for seed in 0 1 2 3 4
do
  OMP_NUM_THREADS=1 python main.py --config-file configs/minigrid/clear_minigrid_single.json --resume-id ${seed}
  OMP_NUM_THREADS=1 python main.py --config-file configs/minigrid/impala_minigrid_single.json --resume-id ${seed}
done